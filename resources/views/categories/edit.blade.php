...
<div class="container-fluid py-4" style="background: linear-gradient(135deg, #f5f7fa 0%, #c3cfe2 100%); min-height: 100vh;">
    ...
    <div class="mb-4">
        ...
        <small class="text-muted" style="font-size: 0.85rem;">Update category details</small>
    </div>
        ...
        <div class="card-body p-4">
            <form method="POST" action="{{ route('categories.update', $category->id) }}">
                ...
                <div class="d-flex gap-2 pt-3 border-top">
                    ...
                    <button type="submit" class="btn btn-primary shadow-sm" style="padding: 0.6rem 1.5rem; font-size: 0.9rem; flex: 1; box-shadow: 0 3px 10px rgba(13, 110, 253, 0.2);">
    ...
    <!-- Info Card -->
    <div class="mt-4 p-3 rounded-2" style="background-color: #fff3cd; border-left: 4px solid #ffc107;">
        <p class="mb-0 text-dark" style="font-size: 0.85rem;">
            <i class="fas fa-lightbulb text-warning me-2"></i>
            <strong>Note:</strong> Changes to the category name will be reflected across all associated products.
        </p>
    </div>
</div>
