...
<div class="container-fluid py-4" style="background: linear-gradient(135deg, #f5f7fa 0%, #c3cfe2 100%); min-height: 100vh;">
    ...
    <div class="mb-4">
        ...
        <small class="text-muted" style="font-size: 0.85rem;">Update product details and images</small>
    </div>
        ...
        <div class="card-body p-4">
            <form method="POST" action="{{ route('products.update', $product->id) }}" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        <label class="form-label fw-600 text-dark mb-2" style="font-size: 0.9rem;">
                            <i class="fas fa-image text-success me-2"></i>Current Images
                        </label>
                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        <label class="form-label fw-600 text-dark mb-2" style="font-size: 0.9rem;">
                            <i class="fas fa-images text-primary me-2"></i>Update Images
                        </label>
                ...
                <div class="row mb-3" id="previewSection" style="display: none;">
                    <div class="col-md-12">
                        <label class="form-label fw-600 text-dark mb-2" style="font-size: 0.9rem;">
                            <i class="fas fa-check-circle text-success me-2"></i>New Images Preview
                        </label>
